...
import { AppLoading, Asset, Font, Icon, BackgroundFetch } from 'expo';
...
export default class App extends Component {
  ...
  render(){
    ...
    for(let i=0; i<4;i++)
    {
      ...
      for(let j=0; j<3; j++)
      {
        row.push(<TouchableOpacity key={nums[i][j]} onPress={()=> this.buttomPressed(nums[i][j])} style={styles.btn}>
